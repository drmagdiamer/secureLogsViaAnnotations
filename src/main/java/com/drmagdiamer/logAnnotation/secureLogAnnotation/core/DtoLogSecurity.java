...
public abstract class DtoLogSecurity {
    ...
    static private LogSecurityMasker defaultMasker= new DefaultMasker();
    static private LogSecurityEncoder encryptor = new DefaultEncryptor();

    static private Map<String,LogSecurityMasker> maskLibrary= new HashMap<>();
        ...
        try {
            ...
            if (field.isAnnotationPresent(Masked.class))
            {
                ...
                if(maskeName == null || maskeName.isEmpty()){
                    ...
                    if(masker == null)
                        throw new RuntimeException("No such masker : "+maskeName);
                }
            ...
            throw new RuntimeException("HipaaComplianceDataModel::get() -  Error in attribute name " + fieldNameName);
        }
    ...
    public String toString() {
        ...
        for ( Field field: clazz.getDeclaredFields())
        {
            ...
            else if (field.isAnnotationPresent(Encrypted.class))
            {
                ...
                order = s.order();
                Map<String,String> fields = getFieldList(fieldList, order);
                fields.put(field.getName(), (value==null)?null:"\""+  encryptor.encrypt(value) +"\"" );
            }
            else if (field.isAnnotationPresent(Unrestricted.class))
            {
    ...
    private Map<String,String> getFieldList( TreeMap<Integer, Map<String,String>> fieldList, int order) {
